# Generated by Django 3.0.3 on 2020-07-09 09:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Department',
            fields=[
                ('dept', django_bleach.models.BleachField(max_length=50, primary_key=True, serialize=False, validators=[django.core.validators.RegexValidator(message='Invalid Text-Field Input', regex='^[a-zA-Z0-9\\.\\-_\\@]*$')])),
            ],
            options={
                'managed': True,
            },
        ...
        migrations.CreateModel(
            name='Faculty',
            fields=[
                ('fac_id', django_bleach.models.BleachField(max_length=50, primary_key=True, serialize=False, validators=[django.core.validators.RegexValidator(message='Invalid Text-Field Input', regex='^[a-zA-Z0-9\\.\\-_\\@]*$')])),
                ('name', django_bleach.models.BleachField(max_length=100, validators=[django.core.validators.RegexValidator(message='Invalid Text-Field Input', regex='^[a-zA-Z0-9\\.\\-_\\@]*$')])),
        ...
        migrations.CreateModel(
            name='Panel',
            fields=[
                ('panel_year_code', django_bleach.models.BleachField(db_column='panel_year_code', max_length=10, validators=[django.core.validators.RegexValidator(message='Invalid Text-Field Input', regex='^[a-zA-Z0-9\\.\\-_\\@]*$')])),
                ('panel_id', django_bleach.models.BleachField(db_column='panel_id', max_length=10, validators=[django.core.validators.RegexValidator(message='Invalid Text-Field Input', regex='^[a-zA-Z0-9\\.\\-_\\@]*$')])),
                ('panel_name', django_bleach.models.BleachField(blank=True, max_length=100, null=True, validators=[django.core.validators.RegexValidator(message='Invalid Text-Field Input', regex='^[a-zA-Z0-9\\.\\-_\\@]*$')])),
                ('is_active', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            name='Team',
            fields=[
                ('team_year_code', django_bleach.models.BleachField(db_column='team_year_code', max_length=10, validators=[django.core.validators.RegexValidator(message='Invalid Text-Field Input', regex='^[a-zA-Z0-9\\.\\-_\\@]*$')])),
                ('team_id', django_bleach.models.BleachField(db_column='team_id', max_length=10, validators=[django.core.validators.RegexValidator(message='Invalid Text-Field Input', regex='^[a-zA-Z0-9\\.\\-_\\@]*$')])),
                ('team_name', django_bleach.models.BleachField(blank=True, max_length=100, null=True, validators=[django.core.validators.RegexValidator(message='Invalid Text-Field Input', regex='^[a-zA-Z0-9\\.\\-_\\@]*$')])),
                ('description', django_bleach.models.BleachField(blank=True, max_length=200, null=True, validators=[django.core.validators.RegexValidator(message='Invalid Text-Field Input', regex='^[a-zA-Z0-9\\.\\-_\\@]*$')])),
                ('id', models.AutoField(db_column='id', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remark', django_bleach.models.BleachField(blank=True, max_length=200, null=True, validators=[django.core.validators.RegexValidator(message='Invalid Text-Field Input', regex='^[a-zA-Z0-9\\.\\-_\\@]*$')])),
                ('id', models.AutoField(db_column='id', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', django_bleach.models.BleachField(max_length=10, validators=[django.core.validators.RegexValidator(message='Invalid Phone number', regex='^[0-9]{10}$')])),
                ('dept', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='eval.Department')),
                ('team_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='eval.Team')),
            ],
            options={
                'managed': True,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', django_bleach.models.BleachField(blank=True, max_length=200, null=True, validators=[django.core.validators.RegexValidator(message='Invalid Text-Field Input', regex='^[a-zA-Z0-9\\.\\-_\\@]*$')])),
                ('is_evaluated', models.BooleanField(default=False)),
                ('id', django_bleach.models.BleachField(max_length=200, primary_key=True, serialize=False, validators=[django.core.validators.RegexValidator(message='Invalid Text-Field Input', regex='^[a-zA-Z0-9\\.\\-_\\@]*$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('viva_voce', models.IntegerField()),
                ('comments', django_bleach.models.BleachField(blank=True, max_length=200, null=True)),
                ('is_evaluated', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', django_bleach.models.BleachField(db_column='id', max_length=23, primary_key=True, serialize=False, validators=[django.core.validators.RegexValidator(message='Invalid Text-Field Input', regex='^[a-zA-Z0-9\\.\\-_\\@]*$')])),
