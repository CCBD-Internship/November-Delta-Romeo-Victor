...
function C_TFR_getFac(p_year_code, p_id, tyc, tid) {
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == XMLHttpRequest.DONE && this.status == 200) {
            ...
            if (rc[0] != 0) {
                document.getElementById("C_TFR_R1_table").style.display = "inline"
                document.getElementById("C_TFR_R1_tbody").innerHTML = strs[0]
                document.getElementById("C_TFR_R1_tbody_error").innerHTML = ""
            }
            else {
                document.getElementById("C_TFR_R1_table").style.display = "none"
                document.getElementById("C_TFR_R1_tbody_error").innerHTML = "No faculty added"
            }
            if (rc[1] != 0) {
                document.getElementById("C_TFR_R2_table").style.display = "inline"
                document.getElementById("C_TFR_R2_tbody").innerHTML = strs[1]
                document.getElementById("C_TFR_R2_tbody_error").innerHTML = ""
            }
            else {
                document.getElementById("C_TFR_R2_table").style.display = "none"
                document.getElementById("C_TFR_R2_tbody_error").innerHTML = "No faculty added"
            }
            if (rc[2] != 0) {
                document.getElementById("C_TFR_R3_table").style.display = "inline"
                document.getElementById("C_TFR_R3_tbody").innerHTML = strs[2]
                document.getElementById("C_TFR_R3_tbody_error").innerHTML = ""
            }
            else {
                document.getElementById("C_TFR_R3_table").style.display = "none"
                document.getElementById("C_TFR_R3_tbody_error").innerHTML = "No faculty added"
            }
            if (rc[3] != 0) {
                document.getElementById("C_TFR_R4_table").style.display = "inline"
                document.getElementById("C_TFR_R4_tbody").innerHTML = strs[3]
                document.getElementById("C_TFR_R4_tbody_error").innerHTML = ""
            }
            else {
                document.getElementById("C_TFR_R4_table").style.display = "none"
                document.getElementById("C_TFR_R4_tbody_error").innerHTML = "No faculty added"
            }
            if (rc[4] != 0) {
                document.getElementById("C_TFR_R5_table").style.display = "inline"
                document.getElementById("C_TFR_R5_tbody").innerHTML = strs[4]
                document.getElementById("C_TFR_R5_tbody_error").innerHTML = ""
            }
            else {
                document.getElementById("C_TFR_R5_table").style.display = "none"
                document.getElementById("C_TFR_R5_tbody_error").innerHTML = "No faculty added"
            }
